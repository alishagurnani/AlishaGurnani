...
ACS_Crosswalk <- read_excel("/Users/agurnani/Documents/Spring Semester/Thesis/R Scripts /nem-occcode-acs-crosswalk.xlsx",
                                sheet= 1,
                                skip = 5,
...
BLS_2010 <- read_excel("/Users/agurnani/Documents/Spring Semester/Thesis/Data/Education and Training Classifications 2010-present.xlsx",
                                  sheet= 1,
                                  skip = 2,
...
write.csv(AcsBls_Cross2010, "/Users/agurnani/Documents/Spring Semester/Thesis/Data/Processed/ACS_BLS_2010.csv", row.names = FALSE)
